...
chunk -> _ ( series_of_statements | class | class_extends) _ {%function(d){return d[1][0];}%}
...
statement ->  func | typeless_function | typeless_variable_declaration | plusEquals | minusEquals | declare_constant | initializeArray | print | comment | switch | setVar | initializeVar | functionCallStatement | return | if | while | forInRange
