...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,21],$V1=[1,13],$V2=[1,26],$V3=[1,7],$V4=[1,9],$V5=[1,10],$V6=[1,11],$V7=[1,12],$V8=[1,15],$V9=[1,16],$Va=[1,17],$Vb=[1,18],$Vc=[1,22],$Vd=[1,23],$Ve=[1,27],$Vf=[1,28],$Vg=[15,18,28,29,43,47,48,49,51,61,62,63,64,67,68,107,108],$Vh=[15,18,23,28,29,43,47,48,49,51,58,61,62,63,64,67,68,107,108],$Vi=[1,36],$Vj=[2,23],$Vk=[7,45],$Vl=[1,44],$Vm=[1,45],$Vn=[1,49],$Vo=[1,55],$Vp=[1,47],$Vq=[1,50],$Vr=[1,54],$Vs=[1,56],$Vt=[1,59],$Vu=[1,64],$Vv=[18,32],$Vw=[2,141],$Vx=[1,77],$Vy=[18,21,34,44,79,110],$Vz=[18,21,32,34,44,79,110],$VA=[1,109],$VB=[1,110],$VC=[1,102],$VD=[1,103],$VE=[1,104],$VF=[1,105],$VG=[1,106],$VH=[1,107],$VI=[1,108],$VJ=[1,111],$VK=[1,112],$VL=[1,113],$VM=[1,114],$VN=[1,115],$VO=[7,23,32,34,44,45,53,76,79,85,86,87,88,89,90,91,92,93,94,95,96,102],$VP=[2,131],$VQ=[1,116],$VR=[1,117],$VS=[7,23,32,34,45,53,79,85,86,87,88,89,90,91,92,93,94,95,96,102],$VT=[1,120],$VU=[1,126],$VV=[1,125],$VW=[1,131],$VX=[2,155],$VY=[1,132],$VZ=[1,133],$V_=[1,147],$V$=[23,58],$V01=[18,23,28,29,43,47,48,49,51,58,61,62,63,64,67,68,107,108],$V11=[15,18,23,28,29,43,47,48,49,51,58,61,62,63,64,67,68,107,108,111],$V21=[1,199],$V31=[18,21,34,44,79,101,110],$V41=[7,23,45,53,79,85,86,87,102],$V51=[7,23,45,53,79,85,86,87,88,89,102],$V61=[7,23,45,53,79,85,86,87,88,89,90,91,102],$V71=[7,23,32,34,45,53,79,85,86,87,88,89,90,91,102],$V81=[7,23,32,34,45,53,79,85,86,87,88,89,90,91,92,93,102],$V91=[1,230],$Va1=[23,45],$Vb1=[7,23,45],$Vc1=[7,19,23,32,34,44,45,53,76,79,85,86,87,88,89,90,91,92,93,94,95,96,101,102],$Vd1=[1,245],$Ve1=[1,256],$Vf1=[1,262],$Vg1=[2,147],$Vh1=[1,268],$Vi1=[7,23,32,34,45,53,76,79,85,86,87,88,89,90,91,92,93,94,95,96,102],$Vj1=[23,60],$Vk1=[45,79],$Vl1=[23,28,29];
...
this.$ = $$[$0-1].concat([$$[$0]]);
break;
case 6: case 10: case 13: case 22: case 50: case 119: case 146:
this.$ =
 [$$[$0]];
break;
case 7:
...
this.$ = [".",[$$[$0-2]].concat($$[$0])]
break;
case 88: case 149: case 151: case 155: case 157:
this.$ = [$$[$0]];
break;
case 89: case 135:
this.$ = [$$[$0-3],$$[$0-1]]
...
this.$ = [".", $$[$0]];
break;
case 117: case 118: case 145: case 148: case 150: case 154: case 156:
this.$ = [$$[$0-2]].concat($$[$0]);
break;
case 120: case 121:
