...
statement_with_semicolon =
	"my" __ b:var_name _ "=" _ c:expr {return ["initialize_var","Object",b,c]} /
	"my" __ b:var_name {return ["initialize_empty_var","Object",b]} /
	...
	"print" _ "(" _ a:expr _ "." _ "\\n" _ ")" {return ["println",a];} /
	"print" _ "(" _ a:expr _ ")" {return ["print",a];} /
