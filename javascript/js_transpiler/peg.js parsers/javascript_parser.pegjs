...
function = "function" __ b:var_name _ "(" _ c:parameters _ ")" _ "{" d:statements "}" {return ["function","public","Object",b[1],c,d];}
...
statement_with_semicolon =
	...
	"console" _ "." _ "log" _ "(" _ a:expr _ ")" {return ["println",a];} /
...
dot_expr =
	...
	//type conversions
	"toDouble" _ "(" _ a:expr _ ")" {return ["convert","Object","double",a];} /
    "toString" _ "(" _ a:expr _ ")" {return ["convert","Object","String",a];} /
	a:factor _ "." _ "length" {return ["string_or_array_length",a];} /
