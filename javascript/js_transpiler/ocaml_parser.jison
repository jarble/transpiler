...
statement_:
	"type" IDENTIFIER "=" data_type_or ";" {$$ = ["algebraic_data_type",$2,$4];}
...
statement_with_parentheses:
	...
	| "match" parentheses_expr "with" case_statements {$$ = ["switch",$2,$4];}
...
parentheses_expr:
    "(" "fun" "(" parameters ")" "->" e ")" {$$ = ["anonymous_function","Object",$4,["statements",[["semicolon",["return",$7]]]]];}
    |"(" access_array ")" {$$ = $2}
