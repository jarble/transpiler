...
function var_type(input_lang,lang,type){
	...
	if(type[0] == "ArrayList"){
		...
		if(member(lang,['hack','nim','elm','ats','python','systemverilog','transact-sql','dafny','janus','chapel','minizinc','engscript','cython','algol 68','d','octave','tcl','ml','awk','julia','gosu','ocaml','f#','pike','objective-c','go','cobra','dart','groovy','hy','java','c#','c','c++','vala','nemerle'])){
			return "int";
		}
		...
		else if(member(lang,['c++','coq','nim','octave','dafny','chapel','c','rust','minizinc','engscript','dart','d','vala','go','cobra','c#','f#','php','hack'])){
            return "bool";
        }
...
function semicolon(lang,statement){
	if(member(lang,['visual basic .net','idris','coq','nim','emacs lisp','chr.js','bash','tcl','elixir','maxima','coconut','english','elm','ats','z3py','cython','kotlin','wolfram','clojure','hack','ocaml','coffeescript','python','smt-lib','smt-lib','scala','clips','pddl','sympy','r','constraint handling rules','pydatalog','common lisp','gnu smalltalk','ruby','lua','hy','picolisp','logtalk','minizinc','swift','rebol','awk','fortran','go','picat','julia','prolog','haskell','mathematical notation','erlang','smt-lib'])){
		return statement;
	}
	else if(member(lang,['c','lc++','reasoned-php','logicjs','yacas','gap','vhdl','f#','php','dafny','chapel','katahdin','frink','falcon','aldor','idp','processing','seed7','drools','engscript','openoffice basic','ada','algol 68','d','ceylon','rust','typescript','octave','autohotkey','pascal','delphi','javascript','pike','objective-c','java','dart','c#','c++','bc','perl','perl 6','nemerle','vala','haxe'])){
		return statement+";";
	}
	else{
...
function infix_arithmetic_lang(lang){
	return member(lang,['pascal','idris','lc++','chr.js','mercury','constraint handling rules','yacas','english','jison','prolog','elm','z3py','logtalk','picat','prolog','sympy','vhdl','elixir','python','visual basic .net','ruby','lua','scriptol', 'smt-libpy','ats','pydatalog','e','vbscript','livecode','monkey x','perl 6','englishscript','cython','gap','mathematical notation','wolfram','chapel','katahdin','frink','minizinc','picat','java','eclipse','d','ooc','genie','janus','pl/i','idp','processing','maxima','seed7','self','gnu smalltalk','drools','standard ml','oz','cobra','pike','prolog','engscript','kotlin','pawn','freebasic','matlab','ada','freebasic','gosu','gambas','nim','autoit','algol 68','ceylon','groovy','rust','coffeescript','typescript','fortran','octave','ml','hack','autohotkey','scala','delphi','tcl','swift','vala','c','f#','c++','dart','javascript','rebol','julia','erlang','ocaml','c#','nemerle','awk','java','perl','haxe','php','haskell','go','r','bc','visual basic']);
}
...
function parameter(input_lang,lang,x){
	if(typeof(x) === "string"){
		...
		else if(member(lang,['haskell','idris','lc++','emacs lisp','chr.js','reasoned-php','logicjs','yacas','elixir','erlang','elm','z3py','php','prolog','picat','definite clause grammars','nearley','sympy','pydatalog','python','english','ruby','lua','gap','hy','perl 6','cosmos','polish notation','reverse polish notation','scheme','mathematical notation','lispyscript','clips','clojure','f#','ml','racket','ocaml','common lisp','newlisp','frink','picat','idp','powershell','maxima','icon','coffeescript','octave','autohotkey','constraint handling rules','logtalk','awk','kotlin','dart','javascript','nemerle','erlang','php','autoit','r','bc'])){
	...
	//optional parameters
		...
		else if(member(lang,["python","octave",'autohotkey','julia','nemerle','php','javascript','r'])){
			return name+"="+body;
		}
...
function statements(input_lang,lang,indent,arr){
		...
		if(member(lang,['java','idris','coq','lc++','chr.js','reasoned-php','logicjs','tcl','yacas','coconut','gap','lark',"pypeg",'canopy','ats','z3py',"peg.js","antlr","nearley",'jison','vhdl','c','pseudocode','perl 6','haxe','javascript','c++','c#','php','dart','actionscript','typescript','processing','vala','bc','ceylon','hack','perl'])){
			return a.join("");
		}
...
function generate_code(input_lang,lang,indent,arr){
	...
	if(arr === "true" || matches_pattern(arr,[".",["true"]],{})){
		if(member(lang,	['java','coq','tcl','clojure','ruby','lua','constraint handling rules','livecode','gap','dafny','smt-lib','perl 6','chapel','c','frink','elixir','pseudocode','pascal','minizinc','engscript','picat','rust','clojure','nim','hack','ceylon','d','groovy','coffeescript','typescript','octave','prolog','julia','f#','swift','nemerle','vala','c++','dart','javascript','erlang','c#','haxe','go','ocaml','scala','php','rebol'])){
			to_return = "true";
		}
		else if(member(lang,['python','idris','yacas','visual basic .net','pydatalog','hy','cython','autoit','haskell','vbscript','visual basic','monkey x','wolfram','delphi'])){
			to_return = "True";
		}
		...
		else if(member(lang,['julia','reduce','lua','engscript','visual basic','gambas','go','ceylon','wolfram','mathematical notation'])){
			to_return = "(" + arr1 + "^" + arr2 + ")";
		}
		else{
			to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
		...
		[['perl','julia','rebol'],["function_call","reverse",["$a"]]],
		[['ruby'],[".",["$a","reverse"]]],
		...
		else if(member(lang,['java','yacas',"minizinc",'ruby','python','cosmos','nim','octave','r','picat','englishscript','perl 6','wolfram','c','c++','d','c#','julia','perl','haxe','cython','minizinc','scala','swift','go','rust','vala'])){
			to_return = a + " != " + b;
		}
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(member(lang,['java','tcl','autohotkey','ruby','perl 6','katahdin','coffeescript','frink','d','ooc','ceylon','processing','janus','pawn','autohotkey','groovy','scala','hack','rust','octave','typescript','julia','awk','swift','scala','vala','nemerle','pike','perl','c','c++','objective-c','tcl','javascript','r','dart','java','go','php','haxe','c#','wolfram'])){
			to_return = "!"+a;
		}
	...
	/*else if(input_lang === "javascript" && (arr[0] === "typeof")){
		...
		if(member(lang,["java","dart","tcl",'autohotkey',"javascript","typescript","c","c#","haxe","c++","perl","ruby","julia","awk","swift"])){
			to_return = a+"?"+b+":"+c;
		}
		else if(member(lang,["php"])){
			to_return = "("+a+"?"+b+":"+c+")";
		}
		else if(member(lang,["coffeescript","haskell","ada","mercury"])){
	...
	//This overloading method is defined outside of a class
		...
		if(member(lang,['ruby','yacas','python','c#','julia','d','swift','julia','janus','minizinc','picat','nim','autoit','python_temp','cython','coffeescript','dart','typescript','awk','vala','perl','javascript','go','c++','php','haxe','c'])){
		...
		if(member(lang,["java","c#"])){
			...
			to_return = "Definition "+name+" "+params+":"+var_type(input_lang,lang,type)+" := "+body;
		}
		...
		else if(member(lang, ['erlang','haskell'])){
			to_return = name + "=" + expr;
		}
		else if(member(lang, ['perl 6'])){
		...
		else if(member(lang,['chapel','nim'])){
	...
	*/
		...
		if(member(lang,['python', 'coffeescript', 'english_temp', 'cosmos', 'ruby', 'lua', 'dart','javascript','typescript','c++','engscript'])){
		...
		else if(member(lang,['lua','yacas','pseudocode','picat','c#','c++','c','visual basic','visual basic .net','wolfram'])){
			to_return = "{"+list_inner.join(",")+"}";
		}
		//console.log(JSON.stringify(arr));
		...
		if(arr.length === 4){
			...
			if(member(lang,["python","julia"])){
				...
				"(from " + variable + " in " + the_list + " where " + condition + " select " + result+")";
			}
			else if(member(lang,["coffeescript"])){
		...
		else if(member(lang,['gap','seed7','delphi','vhdl','yacas'])){
			to_return = a + " := " + b;
		}
	...
	//do this if it's an identifier
		...
		var b = generate_code(input_lang,lang,indent,arr[2]);
		same_var_type(a,b);
		if(member(lang,['nim','lc++','cython','lua','python','smt-libpy','pydatalog','e','ceylon','perl 6','englishscript','cython','mathematical notation','dafny','wolfram','d','rust','r','minizinc','frink','picat','pike','pawn','processing','c++','ceylon','coffeescript','octave','swift','awk','julia','groovy','erlang','haxe','scala','vala','dart','c#','c','go','haskell'])){
			to_return = a + arr[0] + b;
		}
		else if(member(lang,['sympy'])){
			to_return = "Eq("+a + "," + b + ")";
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		var b = generate_code(input_lang,lang,indent,arr[2]);
		if(member(lang,['javascript','lc++','tcl','autohotkey','katahdin','perl 6','ruby','wolfram','chapel','elixir','frink','ooc','picat','janus','processing','pike','nools','pawn','matlab','hack','gosu','rust','autoit','autohotkey','typescript','ceylon','groovy','d','octave','awk','julia','scala','f#','swift','nemerle','vala','go','perl','java','haskell','haxe','c','c++','c#','dart','r'])){
			to_return = a + "||" + b;
		}
		...
		else if(member(lang,['cosmos','cython','vhdl','python','lua','seed7','livecode','englishscript','cython','gap','mathematical notation','genie','idp','maxima','engscript','ada','newlisp','ocaml','nim','coffeescript','pascal','delphi','erlang','rebol','php'])){
			to_return = a + " or " + b;
		}
		...
		var b = generate_code(input_lang,lang,indent,arr[2]);
		to_return;
		if(member(lang,['javascript','lc++','tcl','autohotkey','ats','ruby','katahdin','perl 6','wolfram','chapel','elixir','frink','ooc','picat','janus','processing','pike','nools','pawn','matlab','hack','gosu','rust','autoit','autohotkey','typescript','ceylon','groovy','d','octave','awk','julia','scala','f#','swift','nemerle','vala','go','perl','java','haskell','haxe','c','c++','c#','dart','r'])){
			to_return = a + "&&" + b;
		}
		else if(member(lang,['logicjs','reasoned-php'])){
			to_return = "and("+a + "," + b+")";
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		var b = generate_code(input_lang,lang,indent,arr[2]);
		if(member(lang,["javascript","nim","octave","coffeescript",'cython','julia',"kotlin","swift","typescript","go","php","ruby","haxe","java","c","c++","c#","perl","visual basic .net","scala","python"])){
			to_return = a + "*=" + b;
		}
		else if(member(lang,["lua","delphi","tcl","wolfram","rebol","ocaml","picat",'maxima','r'])){
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		var b = generate_code(input_lang,lang,indent,arr[2]);
		if(member(lang,["javascript",'nim','cython','julia',"kotlin","scala","typescript","go","swift","java","c","c++","c#","perl","python","ruby","visual basic .net","php","coffeescript","haxe"])){
			to_return = a + "/=" + b;
		}
		else if(member(lang,["lua","delphi","tcl","octave","wolfram","rebol","ocaml","picat",'maxima','r'])){
			return generate_code(input_lang,lang,indent,["set_var",a,["/",a,b]]);
		}
	}
	else if(arr[0] === "+="){
		...
		if(member(lang,["javascript","bash",'python','coconut','haxe','awk',"kotlin",'visual basic .net',"java","c++","c#","c","ruby","typescript"])){
		...
		else if(member(lang,["lua","wolfram","rebol","ocaml","picat",'maxima','yacas','delphi'])){
			return generate_code(input_lang,lang,indent,["set_var",a,["+",a,b]]);
		}
			...
			if(member(lang,['janus','julia','coffeescript','visual basic','visual basic .net','nim','cython','vala','perl 6','dart','typescript','java','c','c++','c#','javascript','haxe','chapel','perl','julia','scala','rust','go','swift'])){
				to_return = a + " += " + b;
			}
		}
	}
	...
	,matching_symbols)){
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		var b = generate_code(input_lang,lang,indent,arr[2]);
		if(member(lang,["javascript",'nim',"coffeescript",'dart','cython','awk',"go",'julia',"kotlins","haxe","typescript","swift","picat","php","ruby","java","c","c++","c#","perl","python","scala","visual basic .net"])){
			to_return = a + "-=" + b;
		}
		else if(member(lang,["lua","delphi","tcl","octave","maxima","wolfram","rebol","ocaml","picat","r","yacas"])){
			return generate_code(input_lang,lang,indent,["set_var",a,["-",a,b]]);
		}
	}
	else if(arr[0] === "++" && arr.length === 2){
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(member(lang,["javascript",'yacas',"typescript","php","kotlin","dart","java","c","c++","c#","perl","haxe","go","wolfram"])){
			to_return = a + "++";
		}
		else if(member(lang,["tcl"])){
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(member(lang,["javascript","octave","coffeescript",'yacas',"typescript","php","kotlin","haxe","scala","java","c","c++","c#","perl","go"])){
			to_return = a + "--";
		}
		else if(member(lang,["tcl"])){
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(member(lang,	['pseudocode','reasoned-php','logicjs','coconut','ats','cython','z3py','kotlin','coffeescript','systemverilog','vhdl','lua','ruby','java','seed7','xl','e','livecode','englishscript','gap','kal','engscript','pawn','ada','powershell','rust','d','ceylon','typescript','hack','autohotkey','gosu','swift','pike','objective-c','c','groovy','scala','julia','dart','c#','javascript','go','haxe','php','c++','perl','vala','rebol','awk','bc','chapel','perl 6','python'])){
			to_return = "return " + a;
		}
		...
		var b = generate_code(input_lang,lang,indent,matching_symbols["$b"]);
		var c = generate_code(input_lang,lang,indent,matching_symbols["$c"]);
		if(member(lang,["python","cython","julia"])){
			to_return = a + "["+a+":"+b+"]"
		}
		else if(member(lang,["ruby"])){
			to_return = a + "["+a+"..."+b+"]"
		...
		types[to_return] = "int";
			...
			[["python",'cython',"lua","haskell","erlang"],[".",["math",["function_call","log",["$a"]]]]],
		...
		[['c',"ocaml",'r','tcl','reduce','sympy','seed7','picat','mathematical notation','julia','d','php','perl','perl 6','maxima','fortran','minizinc','swift','prolog','octave','dart','haskell','c++','scala'],["function_call","cos",["$a"]]]
	],matching_symbols)){
		var output = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
	...
	// see http://rosettacode.org/wiki/Real_constants_and_functions
		...
		[['c','rebol','c++','julia','tcl','perl','php','python','erlang','prolog','swift'],["function_call","abs",["$a"]]]
	],matching_symbols)){
		var output = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		if(member(lang,["ruby"])){
		...
		[['c','tcl','minizinc','c++','perl','php','pl/i','octave','prolog','swift','perl'],["function_call","floor",["$a"]]],
		...
		[["prolog","julia","tcl",'minizinc',"php","c","c++","perl","haskell","python","octave","yacas"],["function_call","round",["$a"]]],
		[["rebol"],["function_call","round",["$a"]]],
		[['ruby'],[".",["$a","round"]]]
	],matching_symbols)){
		var output = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
		...
		[["python","lua","scala","nim"],[".",["math",["function_call","ceil",["$a"]]]]],
		[["rebol"],[".",["math",["function_call","round/ceiling",["$a"]]]]],
		[["c#",'visual basic .net'],[".",["Math",["function_call","Ceiling",["$a"]]]]],
		[['c','tcl','minizinc',"c++",'perl','php','pl/i','octave','swift','julia'],["function_call","ceil",["$a"]]],
		...
		[["c++",'tcl',"haskell","maxima","sympy","c","perl","prolog","swift","php",'julia','octave',"minizinc"],["function_call","asin",["$a"]]],
		...
		[["c++",'tcl',"haskell","c","sympy","perl","maxima","prolog","swift","php","minizinc",'julia','octave'],["function_call","acos",["$a"]]],
		...
		[["c++",'tcl',"c","c++","haskell","sympy","perl","maxima","prolog","swift","php","minizinc",'julia','octave'],["function_call","atan",["$a"]]],
		...
		[['c','haskell','tcl','c++','minizinc','php','perl','julia','octave'],
	...
	,matching_symbols)){
		...
		[['c','haskell','tcl','c++','minizinc','php','perl','octave','julia'],
	...
	,matching_symbols)){
		...
		[['sympy'],
			["function_call","InverseFunction",["$a","$b","$c"]]]
	],matching_symbols)){
		var a = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
		same_var_type(to_return,a);
	...
	,matching_symbols)){
		...
		[['seed7','r','tcl','sympy','reduce','minizinc','c','ocaml','erlang','picat','mathematical notation','julia','d','php','perl','perl 6','maxima','fortran','minizinc','swift','prolog','octave','dart','haskell','c++','scala'],
			["function_call","sin",["$a"]]],
	...
	,matching_symbols)){
		...
		[['c','ocaml','seed7','r','tcl','picat','reduce','mathematical notation','maxima','sympy','julia','d','php','perl','perl 6','maxima','fortran','minizinc','swift','prolog','octave','dart','haskell','c++','scala'],["function_call","tan",["$a"]]]
	],matching_symbols)){
		var output = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		if(member(lang,["c"]) && types[output] === "double"){
	...
	if(to_return === ""){
		...
		if(!member(input_lang,["php","wolfram","english","ruby","haskell","constraint handling rules","clips","prolog","lua","javascript","jison"]) && types[to_return] == undefined && !is_a_statement(arr[0])){
...
function while_loop(lang,arr1,arr2,indent){
	...
	else if(member(lang,["python","cython","nim"])){
