...
function var_type(input_lang,lang,type){
	...
	if(member(type,type_parameters)){
		...
		else if(member(lang,["pike"])){
			return "mixed";
		}
		else if(member(lang,["spad"])){
			return "Type";
		}
		...
		if(member(lang,["coq","pvs","vdm-sl","lean"])){
			return "nat";
		}
		else if(member(lang,["c"])){
			return "unsigned";
	...
	else if(member(type, ["char","character"])){
		if(member(lang,["java","vdm-sl","c","standard ml","mysql","rust","ocaml"])){
			return "char";
		}
		...
		else if(member(lang,["ceylon","spad","simula","ocl","vba","agda","modelica","haskell","ada","ruby","cosmos","gambas","openoffice basic","pascal","delphi","visual basic","visual basic .net"])){
			return "Integer";
		}
		else if(member(lang,["php","erlang","fortran","vhdl","prolog","constraint handling rules","common lisp","picat","seed7"])){
            return "integer";
        }
		...
		else if(member(lang,["haxe","q#","julia","jump","x10","alloy","flix","idris","smt-lib","kotlin","ooc","swift","scala","perl 6","smt-lib","monkey x","coq"])){
			return "Int";
		}
	}
	else if(member(type,["double",'float64','Float64','double precision',"Double","number","\"number\""])){
		...
		else if(member(lang,["smt-lib","z3py","modelica"])){
			return "Real";
		}
		...
		else if(member(lang,["vdm-sl","asymptote"])){
			return "real";
		}
		else if(member(lang,["swift","scala","spad"])){
			return "Float";
		}
	}
		...
		else if(member(lang,["smt-lib","modelica"])){
			return "Real";
		}
		else if(member(lang,["vdm-sl"])){
			return "real";
		...
		else if(member(lang,["smt-lib","purescript","q#","elena","ocl","vba","ada","elm","ruby","cosmos","visual basic .net","java","ceylon","gambas","dart","gosu","groovy","scala","pascal","swift","haxe","haskell","visual basic","monkey x"])){
			return "String";
		}
		else if(member(lang,["c++"])){
			return "std::string";
		...
		else if(member(lang,["c++","futhark","lean","isabelle/hol","alt-ergo","algol 68","protobuf","thrift","mercury","coq","nim","elena","octave","dafny","chapel","c","rust","minizinc","engscript","dart","d","vala","go","cobra","c#","f#","php","hack"])){
            return "bool";
        }
		else if(member(lang,["haxe","q#","idris","haskell","swift","julia","perl 6","smt-lib","smt-lib","smt-libpy","monkey x"])){
			return "Bool";
		}
		else if(member(lang,["modelica","vba","visual basic","visual basic .net","openoffice basic","ceylon","delphi","pascal","scala"])){
            return "Boolean";
        }
		else if(member(lang,["fortran"])){
			return "LOGICAL";
...
function parameter(input_lang,lang,x){
	...
	if(typeof(x) === "string"){
		...
		if(member(lang,["java","processing","thrift","c#","scriptol","whiley","pseudocode","euphoria"])){
		...
		else if(member(lang,["typescript","vdm-sl","powershell","haxe","standard ml","reasonml"]) && member(x[0],["Object","object"])){
			return name;
		}
		else if(member(lang,["haxe","pvs","vdm-sl","q#","limbo","cuneiform","lustre","simit","reasonml","alloy","flix","standard ml","ada","ats","vhdl","dafny","chapel","pascal","rust","genie","hack","nim","typescript","gosu","delphi","nemerle","scala","swift","eiffel","spad"])){
			if(is_dynamically_typed(input_lang) && is_statically_typed(lang)){
				type = var_type(input_lang,lang,types[x[1]]);
				function_params[function_name][param_index][0] = type;
				param_index += 1;
		...
		else if(member(lang,["c","glsl","pike","rascal","c++","castor","d","algol 68","vala"])){
			if(is_dynamically_typed(input_lang) && is_statically_typed(lang)){
		...
		else if(member(lang,["haskell","pure","order","twelf","ela","songbird","isabelle/hol",'logpy',"ioke","common prolog","ruby-prolog","agda","mercury","idris","lc++","emacs lisp","chr.js","reasoned-php","logicjs","yacas","elixir","erlang","elm","z3py","prolog","clp(fd)","clp(b)","pddl","picat","definite clause grammars","nearley","sympy","sage","pydatalog","python","interactive data language","forth","pop11","erre","efene","jq","purebasic","oz","clay","tensorlang","aimms","rexx",'tex',"asciimath","coffeequate","pari/gp","gdscript","picolisp","autoit","coconut","applescript","english","ruby","lua","inform 6","gap","hy","perl 6","cosmos","polish notation","reverse polish notation","scheme","mathematical notation","lispyscript","clips","kif","clojure","core.logic","minikanren","reazon","minikanren.lua","f#","ml","racket","ocaml","common lisp","shen","acl2","newlisp","frink","picat","idp","maxima","icon","coffeescript","octave","matlab","autohotkey","constraint handling rules","logtalk","awk","kotlin","dart","sentient","javascript","swrl","io","openscad","axiom","spad","maple","pari/gp","tptp","pythological",'simula',"setl","sidef","nemerle","erlang","php","autoit","r","bc"])){
...
function function_call_parameters(input_lang,lang,name,params){
	...
	if(member(lang,["pseudocode","ada","rexx","vala","pike","futhark","asymptote","interactive data language","pvs","vdm_sl","order","swrl","vba","openscad","quorum","coffeequate","pari/gp","algebrite","tptp","drools","alt-ergo","mysql","glsl","sage","kotlin","sentient","chrg","ruby-prolog","yacas","gosu","gap","awk","z3py","peg.js","rbnf","jison","antlr","english","ruby","definite clause grammars","nearley","sympy","systemverilog","vhdl","visual basic .net","perl","constraint handling rules","lua","ruby","python","logpy","tex","asciimath","coconut","javascript","logtalk","nim","seed7","pydatalog",'e',"vbscript","monkey x","livecode","ceylon","delphi","englishscript","cython","vala","dafny","wolfram","gambas","d","frink","chapel","swift","perl 6","janus","mathematical notation","pascal","rust","picat","autohotkey","maxima","octave","matlab","julia","r","prolog","fortran","go","minizinc","erlang","coffeescript","php","hack","java","c#","c","c++","typescript","dart","haxe","scala","visual basic"])){
		return params.join(",");
	}
	else if(member(lang,["hy","egison","forth","core.logic","minikanren","kif","common prolog","emacs lisp","pythological","pddl","newlisp","ocaml","standard ml","f#","polish notation","reverse polish notation","smt-lib","scheme","racket","common lisp","clips","rebol","haskell","pure","coq","twelf","agda","racket","clojure"])){
		return params.join(" ");
	}
	else if(member(lang,["mediawiki"])){
			return params.join("|");
...
function get_lang(lang){
	...
	else if(lang === "lisp flavored erlang"){
		return "lfe";
	}
	else if(lang === "object constraint language"){
		return "ocl";
	}
	else if(lang === "gdl"){
		return "gnu data language";
	}
	else if(lang === "spad"){
		return "spad";
	}
	else if(lang === "idl"){
		return "interactive data language";
	}
	else if(lang === "isabelle"){
		return "isabelle/hol";
	}
	else if(lang === "cycl"){
		return "cyc";
	}
	else if(lang === "knowledge interchange format"){
		return "KIF";
	}
	else if(lang === "cyc"){
		return "cyc";
	...
	else if(member(lang,["bison","yacc"])){
		return "jison";
	}
	else if(lang === "latex"){
		return "tex";
...
function unparse(input_lang,lang,indent,pattern_array,matching_symbols){
	...
	if(pattern_array.length === 1 && typeof(pattern_array[0]) === "string"){
		...
		if(infix_arithmetic_lang(lang)){
			if(member(lang,["prolog"]) && pattern_array[0] === "<="){
				to_return = a + "=<" + b;
			}
			else{
				to_return = a + pattern_array[0] + b;
...
function generate_code(input_lang,lang,indent,arr){
	...
	if(arr[0] === "+" || arr[0] === ".." || (member(input_lang,["haskell","coq","picat"]) && arr[0] === "++") || arr[0] === ".." || (member(input_lang,["php","hack","perl"]) && arr[0] ==="." && arr.length === 3)){
		...
		if(prefix_arithmetic_lang(lang) && (types[a] !== "String") && (types[b] !== "String")){
			...
			//console.log(JSON.stringify(types));
				...
				to_return = inputs_to_outputs(lang,{a1:a,b1:b},
					...
					["icon","maple","ooc","rexx"],
						"a1 || b1",
					["haskell","minizinc","picat","elm","coq","reasonml"],
						"a1 ++ b1",
					["clojure"],
						"(str a1 b1)",
					["emacs lisp"],
		...
		else if(member(lang,["perl","mumps","mysql","transact-sql","choco","clp(b)"])){
			to_return = "1";
		}
		...
		else if(member(lang,["php","whiley"])){
			return "null";
		}
		...
		if(member(lang,	["java","boa","metafont","futhark","postscript","kitten","elena","ocl","quorum","songbird","reasonml","minikanren.lua","core.logic","axiom","alt-ergo","lua","maxima","standard ml","forth","reverse polish notation","sidef","mercury","coq","tcl","clojure","ruby","lua","constraint handling rules","livecode","gap","dafny","smt-lib","perl 6","chapel","c","frink","elixir","pseudocode","pascal","minizinc","engscript","picat","rust","clojure","nim","hack","ceylon","d","groovy","coffeescript","typescript","octave","prolog","julia","f#","swift","nemerle","vala","c++","dart","javascript","erlang","c#","haxe","go","ocaml","scala","php","rebol"])){
			to_return = "false";
		}
		else if(member(lang,["python","qore","isabelle/hol","sage","z3py","coconut","idris","yacas","visual basic .net","pydatalog","hy","cython","autoit","haskell","vbscript","visual basic","monkey x","wolfram","delphi"])){
			to_return = "False";
		}
		else if(member(lang,["clips","r","ada","tla+"])){
			to_return = "FALSE";
		...
		else if(member(lang,["perl","mumps","mysql","transact-sql","clp(b)"])){
			to_return = "0";
		}
		else if(member(lang,["hol"])){
			to_return = "F";
		...
		[["lua","python"],[".",["math","pi"]]],
		[["perl","perl 6","octave","rebol","symja","sage","min"],[".",["pi"]]],
		...
		//e^x
		[["c","postscript","limbo","algebrite","modelica","yacas","mysql","r","hlsl","octave","php","python","maple","c++","common lisp","perl","minizinc"],["function_call","exp",["$a"]]],
		...
		[["c","metafont","postscript","kif","modelica","asciimath","mysql","pari/gp","mediawiki","hlsl","standard ml","reverse polish notation","tcl","minizinc","c++","perl","php","ooc","octave","matlab","prolog","swift","perl"],["function_call","floor",["$a"]]],
	...
	,matching_symbols)){
		...
		if(lang === "haskell"){
			...
			return "(loop for "+b+" from "+c+" to "+d+" summing "+a+")";
		}
		else if(lang === "erlang"){
			return "lists:sum(["+a+" || "+b+" <- lists:seq("+c+","+d+")])";
		}
		else if(lang === "tex"){
			return "\sum_{"+b+" ="+c+"}^{"+d+"} "+a;
		}
		else if(lang === "ruby"){
			return "("+c+".."+d+").inject{|sum, "+b+"| sum + "+a+"}";
		}
		else{
			to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
		}
	...
	,matching_symbols)){
		...
		else if(lang === "mediawiki"){
			to_return = "{{{"+(parseInt(generate_code(input_lang,lang,indent,matching_symbols["$a"]))+1)+"}}}"
		}
		else{
	...
	,matching_symbols)){
		var a = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		if(member(lang,["maxima","wolfram","algebrite","pari/gp"])){
			to_return = "("+a + ")!";
		}
		else{
			to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
	...
	,matching_symbols)){
		...
		else if(member(lang, ["python","coconut","cython","haskell","java"])){
			to_return = "@constraint(" + a + ")";
		}
	...
	,matching_symbols)){
		...
		if(member(lang,["seed7","vdm-sl","mumps","go","smalltalk","axiom","coffeequate","mysql","pl/sql","prolog","sympy","python","coconut","cython","ruby","chapel","haskell","cobol","picat","ooc","ooc","rexx","maxima","awk","r","f#","autohotkey","tcl","autoit","groovy","octave","perl","perl 6","fortran"])){
			to_return = "(("+arr1+")**("+arr2+"))";
		}
		...
		else if(member(lang,["java","maxscript","q#","dafny","songbird","tptp","prover9","sentient","glsl","yacas","minizinc","ruby","python","simit","coconut","cosmos","nim","octave","r","picat","englishscript","perl 6","wolfram","c","c++","d","c#","julia","perl","haxe","cython","minizinc","scala","swift","go","rust","vala"])){
			to_return = a + " != " + b;
		}
		...
		else if(member(lang,["java","boa","songbird","chapel","tcl","autohotkey","ruby","perl 6","katahdin","coffeescript","frink","d","ooc","ceylon","processing","janus","pawn","autohotkey","groovy","scala","hack","rust","octave","typescript","julia","awk","swift","scala","vala","nemerle","pike","perl","c","c++","objective-c","tcl","javascript","r","dart","java","go","php","haxe","c#","wolfram"])){
			to_return = "!"+a;
		}
		else if(member(lang,["python","simit","alloy",'shen','acl2',"modelica","alt-ergo","coconut","scheme","smt-lib","lua","cython","pddl","mathematical notation","emacs lisp","minizinc","picat","genie","seed7","smt-lib","idp","maxima","clips","engscript","hy","ocaml","clojure","erlang","pascal","delphi","f#","ml","racket","common lisp","rebol","haskell","sibilant"])){
			to_return = "(not "+a+")";
		}
		else if(member(lang,["visual basic","lustre","visual basic .net","autoit","livecode","monkey x","vbscript"])){
			to_return = "(Not "+a+")";
		}
		else if(member(lang,["coq","matlab","tptp","hol","ileansep","ileantap","sympy","sage"])){
			to_return = "~"+a;
		}
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(infix_arithmetic_lang(lang) || member(lang,["tex","regex","antlr","jison","order","interactive data language"])){
			to_return = "("+a+")";
		}
		if(member(lang,["regex"])){
			to_return  = "\"(\"+"+a+"+\")\"";
		}
		else if(prefix_arithmetic_lang(a)){
			to_return = a;
		}
		same_var_type(to_return,a);
	}
	...
	//set_dict in grammar file
		...
		[["acl2","maxima","newlisp"],["function_call","append",["$a","$b"]]],
		...
		if(member(lang,["java","openscad","reasonml","vala","sidef","dart","tcl","autohotkey","javascript","typescript","c","c#","haxe","c++","perl","ruby","julia","awk","swift"])){
			to_return = a+"?"+b+":"+c;
		}
		else if(member(lang,["php","hack"])){
			to_return = "("+a+"?"+b+":"+c+")";
		...
		else if(member(lang,["modelica","lustre","isabelle/hol","xquery","futhark","coffeescript","standard ml","ada","coq","chapel","haskell","ada","mercury"])){
			to_return = "(if "+a+" then "+b+" else "+c+")";
		}
		else if(member(lang,["python","coconut"])){
			to_return = "("+b+" if "+a+" else "+c+")";
		}
		else if(member(lang,["fermat"])){
			to_return = " if"+a+" then "+b+" else "+c+"fi ";
		}
		...
		var if_statement2 = generate_code(input_lang,lang,indent+"    ",arr[2]);
		if(arr.length === 3){
			if(member(lang,["d","pike","q#","powershell","glsl","kotlin",'e',"php","perl","mathematical notation","chapel","pawn","ceylon","scala","typescript","autohotkey","awk","r","groovy","gosu","katahdin","java","swift","nemerle","c","dart","vala","javascript","c#","c++","haxe"])){
				to_return = "if(" + if_statement1 + "){" + if_statement2 +indent+ "}";
			}
			else if(member(lang,["rust","go","tensorlang"])){
				to_return = "if " + if_statement1 + " {" + if_statement2 +indent+ "}";
			}
			else if(member(lang,["mysql"])){
			...
			else if(member(lang,["applescript","euphoria"])){
				to_return = "if " + if_statement1 + " then "  + if_statement2 +indent+ "end if";
			}
			else if(member(lang,["forth"])){
				to_return = if_statement1+" IF "+if_statement2+" THEN";
			}
			else if(member(lang,["haskell","coq","vdm-sl","f#","isabelle/hol","standard ml","elm","maxima"])){
			...
			if(member(lang,["d","powershell","dafny","kotlin","kitten",'e',"php","openscad","hack","perl","mathematical notation","chapel","pawn","ceylon","scala","typescript","autohotkey","awk","r","groovy","gosu","katahdin","java","swift","nemerle","c","dart","vala","javascript","c#","c++","pike","glsl","haxe"])){
			...
			else if(member(lang,["haskell","pure","futhark","coq","vdm-sl","f#","standard ml","elm","maxima","clips","isabelle/hol"])){
		...
		to_return = inputs_to_outputs(lang,{statements1:statements1," indent ":indent},
			["hack","openscad","tensorlang","pike","kitten","glsl","kotlin",'e',"ooc","englishscript","mathematical notation","dafny","perl 6","frink","chapel","katahdin","pawn","powershell",'puppet',"ceylon","d","rust","typescript","scala","autohotkey","gosu","groovy","java","swift","dart","awk","javascript","haxe","php","c#","go","perl","c++","c","tcl","r","vala","bc"],
				"else{statements1 indent }",
			["visual basic .net","purebasic"],
				"Else statements1",
			["clojure"],
				":else statements1",
			["python","coconut"],
				"else:statements1",
			["seed7","matlab","futhark","modelica","applescript","standard ml","elixir","gap","elm","coffeescript","fortran","vhdl","ruby","lua","aimms","livecode","janus","haskell","ada","pure","coq","vdm-sl","isabelle/hol","clips","minizinc","julia","octave","picat","pascal","delphi","maxima","ocaml","f#"],
				"else statements1",
		...
		if(member(lang,["java","reasonml","d","powershell","nemerle","typescript","hack","swift","groovy","dart","awk","c#","javascript","c++","php","c","go","haxe","vala"])){
		...
		else if(member(lang,["haskell","standard ml","isabelle/hol"])){
		...
		|| member(lang,["rust","scala","standard ml","reasonml"])
			&& (to_return = "_ =>" + statements1)
		|| member(lang,["tcl"])
		...
		if(member(lang,["d","pike","openscad",'e',"mathematical notation","chapel","pawn","ceylon","scala","typescript","autohotkey","awk","r","groovy","gosu","katahdin","java","swift","nemerle","c","dart","vala","javascript","c#","c++","glsl","haxe"])){
		...
		else if(member(lang,["minizinc","modelica","picat","lua","mysql","aimms"])){
		...
		else if(member(lang,["ocaml","applescript","haskell","pure","coq","vdm-sl","futhark","isabelle/hol","hol","standard ml","elm","pascal","maxima","delphi","livecode"])){
	...
	//define a subclass
		...
		|| member(lang,["kif"])
			&& (to_return = "(subclass "+name+" "+name1+") (=> "+body+indent+")")
		|| member(lang,["pop11"])
			&& (to_return = "define :class "+name+" is "+name1+";"+body+indent+"enddefine;")
		|| member(lang,["ometa"])
			&& (to_return = "ometa "+name+" <: "+name1+"{"+body+indent+"}")
		...
		|| member(lang,['alloy'])
			&& (to_return = "sig "+name+" extends "+name1+"{"+body+indent+"}")
		|| member(lang,["c++"])
		...
		|| member(lang,["quorum"])
			&& (to_return = "class "+name+" is "+name1+" "+body+indent+"end")
		|| member(lang,["coq"])
			&& (to_return = "Inductive "+name+":"+name1+" := "+body)
		|| member(lang,["lean"])
			&& (to_return = "inductive "+name+":"+name1+body)
		|| member(lang,["clips"])
			&& (to_return = "(defclass "+name+" (is-a "+name1+") "+body+")")
		|| member(lang,["common lisp"])
			&& (to_return = "(defclass "+name+" ("+name1+") "+body+")");
	}
		...
		var name = arr[1];
		var body;
		if(member(arr[2],["int","Int","boolean"])){
			body = var_type(input_lang,lang,arr[2]);
		}
		else{
		...
		if(member(lang,["haskell","idris"])){
			...
			to_return = "Inductive "+name+" := "+body;
		}
		else if(member(lang,["isabelle/hol"])){
			to_return = "datatype "+name+" = "+body;
		}
		else if(member(lang,["haxe"])){
		...
		if(member(lang,["haskell","ocaml","idris","coq","f#"])){
			to_return = a+" | "+b;
		}
		else if(member(lang,["prolog","haxe","mercury","haxe"])){
			to_return = a +";"+ b;
		}
	}
		...
		var name = arr[2];
		var body;
		if(member(lang,["alt-ergo","haskell","ocaml","coq"])){
		...
		else if(member(lang,["alt-ergo","ocaml"])){
		...
		var body = generate_code(input_lang,lang,indent+"    ",arr[2]);
		if(member(lang,["java"])){
			to_return = "public class "+name+"{"+body+indent+"}";
		}
		else if(member(lang,["python"])){
			to_return = "@dataclass\nclass "+name+":"+body;
		}
		else if(member(lang,["kotlin"])){
			to_return = "data class "+name+"("+body+indent+")";
		}
		else if(member(lang,["coq"])){
			to_return = "Record "+name+" := {"+body+indent+"}";
		}
		else if(member(lang,["futhark"])){
			to_return = "module "+name+" = {"+body+indent+"}";
		}
		else if(member(lang,["vdm-sl"])){
			to_return = name+"::"+body;
		}
		else if(member(lang,["acl2"])){
			to_return = "(defstructure "+name+" "+body+indent+")";
		}
		else if(member(lang,["sql","mysql","transact-sql"])){
			to_return = "CREATE TABLE "+name+"("+body+indent+");";
		}
		else if(member(lang,["c++","glsl","hlsl","rust","elena","sidef"])){
			to_return = "struct "+name+"{"+body+indent+"};";
		}
		else if(member(lang,["pascal","delphi"])){
			to_return = "type "+name+" = record"+body+indent+"end;";
		}
		else if(member(lang,["nim"])){
			to_return = "type "+name+" = tuple["+body+"]";
		}
		else if(member(lang,["clean"])){
			to_return = ":: " + name + " = {" + body + "}";
		}
		else if(member(lang,["c"])){
			to_return = "typedef struct {"+body+indent+"}"+name+";";
		}
		else if(member(lang,["common lisp"])){
			to_return = "(defstruct "+name+" "+body+indent+")";
		}
		else if(member(lang,["clojure"])){
			to_return = "(defrecord "+name+" ["+body+indent+"])";
		}
		else if(member(lang,["lfe"])){
			to_return = "(defrecord "+name+" "+body+indent+")";
		}
		else if(member(lang,["protobuf"])){
			to_return = "message "+name+"{"+body+indent+"}";
		}
		else if(member(lang,["thrift","swift","c#","stata"])){
			to_return = "struct "+name+"{"+body+indent+"}";
		}
		else if(member(lang,["erlang"])){
			to_return = "-record("+name+", {"+body+indent+"})";
		}
		else if(member(lang,["icon","unicon"])){
			to_return = "record "+name+"("+body+")";
		}
		else if(member(lang,["vhdl","ada"])){
			to_return = "type "+name+" is record"+body+indent+"end record "+name+";";
		}
		else if(member(lang,["stone"])){
			to_return = "struct "+name+body;
		}
		else if(member(lang,["lean"])){
			to_return = "inductive "+name+": Type "+body;
		}
		else if(member(lang,["haskell","songbird","purescript"])){
			to_return = "data "+name+" = "+name+"{"+body+indent+"}";
		}
		else if(member(lang,["q#"])){
			to_return = "newtype "+name+" = "+name+"{"+body+indent+"}";
		}
		else if(member(lang,["ocaml"])){
			to_return = "data "+name+" = {"+body+indent+"}";
		}
		else if(member(lang,["reasonml","standard ml","ocaml"])){
			to_return = "type "+name+" = {"+body+"}";
		}
		else if(member(lang,["coffeescript"])){
			to_return = name+" = "+body;
			...
			to_return = name+" = Struct.new("+body+")";
		}
		else if(member(lang,["go"])){
		...
		else if(member(lang,["freebasic","vba"])){
			to_return = "Type "+name+body+indent+"End Type";
		}
		else if(member(lang,["julia"])){
			to_return = "struct "+name+body+indent+"end";
		}
	}
		...
		var type_params = arr[4].join(",");
		if(member(lang,["typescript","haxe","swift","ceylon","kotlin"])){
		...
		|| member(lang,["pop11"])
			&& (to_return = "define :class "+name+";"+body+indent+"enddefine;")
		|| member(lang,["clips"])
			&& (to_return = "(defclass "+name+" (is-a OBJECT) "+body+")")
		|| member(lang,["common lisp"])
			&& (to_return = "(defclass "+name+" () "+body+")")
		|| member(lang,['alloy'])
			&& (to_return = "sig "+name+"{"+body+indent+"}")
		|| member(lang,['standard ml'])
			&& (to_return = "structure "+name+" = struct"+body+indent+"end")
		|| member(lang,["logtalk"])
		...
		|| member(lang,["gnu smalltalk"])
			&& (to_return = "Object subclass: "+name+"["+body+indent+"]")
		|| member(lang,["f#"])
			&& (to_return = "type "+name+" = "+body)
		|| member(lang,["ocaml"])
			&& (to_return = "class "+name+" = object (self)"+body+indent+"end")
		|| member(lang,["reasonml"])
			&& (to_return = "class "+name+" = {"+indent+"as self;"+body+indent+"}")
		...
		|| member(lang,["futhark"])
			&& (to_return = "module " + name+" = {"+body+indent+"}")
		|| member(lang,["javascript","autohotkey","hack","php","scala","haxe","chapel","swift","d","typescript","dart","perl 6","elena","fantom"])
			&& (to_return = "class "+name+"{"+body+indent+"}");
	}
	...
	//This overloading method is defined outside of a class
		...
		if(member(lang,["java","c#"])){
			...
			if(is_recursive){
				to_return = name + "(" + params+"): RECURSIVE "+var_type(input_lang,lang,type)+" = "+body;
			}
			else{
				to_return = name + "(" + params+"):"+var_type(input_lang,lang,type)+" = "+body;
			}
		}
		else if(member(lang,["coffeescript"])){
		...
		|| member(lang,["standard ml"])
			&& (to_return = "(fn("+params+") => "+body+indent+")")
		|| member(lang,["haskell","futhark","pure"])
			&& (to_return = "(\\"+params+" -> "+body+")")
		|| member(lang,["rebol"])
			&& (to_return = "func["+params+"]["+body+indent+"]")
		...
		member(lang,["prolog"])
			&& (to_return = name+"("+params+") -->"+body)
		||member(lang,["parsimmon"])
			&& (to_return = "function "+name+"("+params+"){return"+body+";}")
		|| member(lang,["chrg"])
		...
		|| member(lang,["nearley"])
			&& (to_return = name+"["+params+"] ->"+body)
		|| member(lang,["parslet"])
			&& (to_return = "def "+name+"("+params+")"+indent+"return "+body+indent+"end")
		|| member(lang,["peg.js"])
		...
		member(lang,["prolog","ileansep"])
			&& (to_return = a+";"+b)
		|| member(lang,["sympy","lua"])
			&& (to_return = a+" or "+b)
		|| member(lang,["abella","hol","whyml"])
			&& (to_return = a+" \\/ "+b)
		...
		if(member(lang,["nearley","ometa","ohm","pyparsing","lemon","chrg","instaparse","parboiled","javacc","waxeye","rebol","lpeg","txl","treetop","abnf","peg.js","antlr","marpa","wirth syntax notation","jison"])){
		...
		|| member(lang,["arpeggio"])
			&& (to_return = "["+a+","+b+"]")
		|| member(lang,["parsimmon"])
			&& (to_return = "Parsimmon.alt("+a+","+b+")")
		|| member(lang,["parsec.el"])
			&& (to_return = "(parsec-or "+a+" "+b+")")
		|| member(lang,["pypeg"])
			&& (to_return = "["+a+","+b+"]")
		|| member(lang,["parboiled"])
			&& (to_return = "AnyOf("+a+","+b+")")
		|| member(lang,["arcsecond"])
			&& (to_return = "choice(["+a+","+b+"])")
		...
		|| member(lang,["clips"])
			&& (to_return = "(and " + a+" "+b+")")
		|| member(lang,["parsec.el"])
			&& (to_return = "(parsec-and "+a+" "+b+")")
		|| member(lang,["parsimmon"])
			&& (to_return = "Parsimmon.seq("+a+","+b+")")
		|| member(lang,["pypeg"])
			&& (to_return = "("+a+","+b+")")
		|| member(lang,["parslet"])
			&& (to_return = "("+a+" >> "+b+")")
		|| member(lang,["parboiled"])
			&& (to_return = "sequenceOf(["+a+","+b+"])")
		|| member(lang,["arcsecond"])
		...
		|| member(lang,["prolog","logtalk","flix"])
			&& (to_return = name+"("+params+") :- "+body)
		|| member(lang,["alloy"])
			&& (to_return = "pred " + name+"("+params+"){"+body+indent+"}")
		...
		|| member(lang,["pydatalog"])
			&& (to_return = name + "(" + params + ")" + "<=" + body)
		|| (to_return = generate_code(input_lang,lang,indent,["function","public","boolean",arr[1],arr[2],arr[3]]));
	}
		...
		if(member(lang,["java","c#"])){
		...
		else if(member(lang,["aimms","interactive data language","q#","swift","eiffel","seed7","chapel","gambas","openoffice basic","vba","mysql","transact-sql","minizinc","coq"])){
			...
			|| (member(lang,["openoffice basic","vba"])) && (
				(var_type(input_lang,"java",type) === "void") &&
		...
		else if(member(lang,["euphoria","vim script"]))
			...
			to_return = "func " + name + "("+params+") -> "+var_type(input_lang,lang,type)+" is "+body+indent+"end func;";
		else if(member(lang,["simit"]))
		...
		else if(member(lang,["c","glsl","vala","processing","rascal"])){
			if(type !== undefined || type === "Object"){
			...
			to_return = "let " + name + " " + params+":"+var_type(input_lang,lang,type)+"="+body+indent+"end";
		}
		else if(member(lang,["delphi"])){
			to_return = "function " + name + "("+params+"):"+var_type(input_lang,lang,type)+"; begin"+body+indent+"end;";
		}
		else if(member(lang,["haskell","clean","pure"])){
			...
			if(types[name] !== "Object"){
				...
				to_return = "fun " + name + " :: \"" + types_list.join(" \u21d2 ") + " \u21d2 " + var_type(input_lang,lang,type) + "\" where " + indent + "\"" + name + " " + params+" = "+body+"\"";
			}
		}
		else if(member(lang,["alt-ergo"])){
			var types_list = arr[4].map(function(x) {
		...
		var a = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
		if(member(lang,["java","autohotkey","engscript","dart","groovy","typescript","javascript","c#","c++","haxe","chapel","julia"])){
			to_return = "this."+a;
		}
		else if(member(lang,["php","hack"])){
			to_return = "$this->"+a;
		...
		if(arr.length === 4){
			...
			else if(member(lang,["haskell","tla+"])){
		...
		else if(member(lang,["ruby","algebrite","matlab","tex","frink","coffeescript","erlang","php","prolog","constraint handling rules","logtalk","picat","octave","wolfram","elm","haskell","python","powershell","elixir","openscad","rexx","mathematical notation","coconut","cython","julia","awk"])){
			to_return = name + "=" + expr;
		}
		else if(member(lang,["sympy"])){
		...
		else if(member(lang,["cuneiform","futhark"])){
			to_return =  "let "+name+":"+var_type(input_lang,lang,arr[1])+"="+expr;
			set_var_type(input_lang,lang,name,arr[1])
		}
		else if(member(lang, ["algol 68"])){
	...
	*/
		...
		if(member(lang,["python","ioke","coconut", "coffeescript", "english_temp", "cosmos", "ruby", "lua", "dart","javascript","reasonml","typescript","c++","engscript"])){
			to_return = "{"+list_inner.join(",")+"}";
		}
		...
		if(member(lang,["tcl"])){
			...
			to_return = inputs_to_outputs(lang,{a1:a,b1:b},
				["javascript","simit","openscad","whiley","glsl","sentient","sage","english","ring","tex","coffeescript","cython","haskell","python","interactive data language","gnu data language","algebrite","coconut","minizinc","systemverilog","elixir","visual basic .net","vba","lua","ruby","scriptol","mathematical notation","perl 6","wolfram","chapel","katahdin","frink","picat","ooc","d","genie","janus","ceylon","idp","processing","java","boo","gosu","pike","kotlin","powershell","engscript","pawn","freebasic","hack","nim","openoffice basic","groovy","typescript","rust","fortran","awk","go","swift","vala","c","julia","scala","cobra","erlang","autoit","dart","java","ocaml","haxe","c#","matlab","c++","comet","php","perl","gambas","octave","visual basic","bc"],
					"a1 = b1",
				["rebol","maxima"],
					"a1: b1",
				["r","hs-logic"],
				...
				["hy"],
					"(setv a1 b1)",
				["gap","boa","fermat","ambienttalk","elena","spad","dafny","modelica","aimms","axiom","io","autohotkey","sather","setl","gnu setl","smalltalk","ada","algol 68","seed7","delphi","vhdl","yacas","icon"],
					"a1 := b1"
			);
		}
	}
	...
	//do this if it's an identifier
		...
		else if(member(lang, ["core.logic","hs-logic"])){
			to_return = "(conso "+a+" "+b+" "+c+")";
		}
		else{
			to_return = unparse(input_lang,lang,indent,pattern_array.value,matching_symbols);
		}
		...
		var b = generate_code(input_lang,lang,indent,arr[2]);
		same_var_type(a,b);
		if(member(lang,["nim","ats","simit","modelica","pari/gp","z3py","sage","kotlin","sentient","english","mathematical notation","lc++","cython","lua","python","coconut","smt-libpy","pydatalog",'e',"ceylon","perl 6","englishscript","cython","dafny","wolfram","d","rust","r","minizinc","frink","picat","pike","pawn","processing","c++","glsl","ceylon","coffeescript","octave","swift","awk","julia","groovy","erlang","haxe","scala","vala","dart","c#","c","go","haskell"])){
			to_return = a + arr[0] + b;
		}
		else if(member(lang,["sympy"])){
			to_return = "Eq("+a + "," + b + ")";
		...
		else if(member(types[a], ["int","float","double","long"]) && member(lang,["maxima","alt-ergo","pl/sql","standard ml","seed7","monkey x","gap","rebol","f#","autoit","pascal","delphi","visual basic","forth","mysql","visual basic .net","ocaml","livecode","vbscript","z notation"])){
			to_return = a + " = " + b;
		}
		...
		else if(member(lang,["smt-lib","clojure","smt-lib","emacs lisp","common lisp","shen","clips","racket"])){
...
;	}
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		var b = generate_code(input_lang,lang,indent,arr[2]);
		if(member(lang,["javascript","tptp","python","c++","c#","php","smalltalk","perl","ruby","java","julia","matlab","r","swift"])){
			to_return = a + "|" + b;
		}
		...
		if(member(lang,["javascript","jump","dafny","alloy","castor","sidef","coq","lc++","tcl","autohotkey","katahdin","perl 6","ruby","wolfram","chapel","elixir","frink","ooc","picat","janus","processing","pike","nools","pawn","matlab","hack","gosu","rust","autoit","autohotkey","typescript","ceylon","groovy","d","octave","awk","julia","scala","f#","swift","nemerle","vala","go","perl","java","haskell","haxe","c","c++","c#","dart","r"])){
			to_return = a + "||" + b;
		}
		else if(member(lang,["cyc"])){
			to_return = "(#$or " + a + " " + b+")";
		...
		else if(member(lang,["minizinc","abella","hol","whyml","lean"])){
			to_return = a + "\\/" + b;
		}
		else if(member(lang,["algol 68"])){
		...
		else if(member(lang,["smt-lib","acl2","snark","common lisp","shen","clips","pddl","clojure","common lisp","emacs lisp","clojure","racket"])){
			to_return = "(or "+a+" "+b+")";
		}
		...
		else if(member(lang,["tptp","songbird","sympy"])){
			to_return = a+" | "+b;
		}
		types[to_return] = "boolean";
	}
		...
		else if(member(lang,["minizinc","hol","whyml","lean"])){
			to_return = a + "/\\" + b;
		}
		else if(member(lang,["reverse polish notation","postscript"])){
			to_return = a + " " + b+" and";
		}
		else if(member(lang,["pydatalog","songbird","mizar","tptp","sympy"])){
			to_return = a + " & " + b;
		}
		else if(member(lang,["mumps"])){
			to_return = a + "&" + b;
		...
		else if(member(lang,["common lisp","lustre","acl2","common prolog","shen","smt-lib","clips","pddl","clojure","common lisp","emacs lisp","clojure","racket"])){
			return "(and "+a+" "+b+")";
		}
		else if(member(lang,["z3py","gologic","pysmt"])){
			to_return = "And("+a+" "+b+")";
		...
		if(member(lang,["javascript","gdscript","maxscript","sentient","english","bash","python","coconut","haxe","awk","kotlin","visual basic .net","java","c++","c#","c","glsl","ruby","typescript"])){
	...
	,matching_symbols)){
		...
		[["python","r","common lisp","parenscript","sql","coconut","cython","php","hack","fortran"],["function_call","min",["$a"]]],
	...
	,matching_symbols)){
		...
		var a = generate_code(input_lang,lang,indent,arr[1]);
		if(member(lang,	["pseudocode","asymptote","hs-logic","rascal","q#","euphoria","tensorlang","x10","processing","io","whiley","songbird","alloy","castor","parasail","nearley",'xquery',"gdscript","sentient","scriptol","setl","gnu setl","inform 6","picolisp","english","matlab","glsl","applescript","sidef","reasoned-php","logicjs","coconut","cython","kotlin","coffeescript","systemverilog","vhdl","lua","ruby","java","seed7",'xl','e',"livecode","englishscript","gap","kal","engscript","pawn","ada","powershell","rust","d","ceylon","typescript","hack","autohotkey","gosu","swift","pike","objective-c","c","groovy","scala","julia","dart","c#","javascript","go","haxe","php","c++","perl","vala","rebol","awk","bc","chapel","perl 6","python"])){
			to_return = "return " + a;
		}
		...
		else if(member(lang,["fortran","simit","vba","openoffice basic","erre"])){
		...
		[["haskell","futhark","emacs lisp","scheme","racket","minizinc","julia","r","octave","seed7","glsl"],["function_call","length",["$a"]]],
		...
		else if(member(lang, ["reasonml","python","rust","ocaml","pascal","delphi","vhdl","vdm-sl","coq"])){
			to_return = indent + arr[2]+":"+var_type(input_lang,lang,arr[1]);
		}
		else if(member(lang, ["vba"])){
		...
		else if(member(lang, ["erlang","common lisp","unicon","icon","sidef"])){
			//for Erlang records
		...
		if(member(lang,["c","c++"])){
			...
			to_return = "TYPE "+type1+" IS "+type2+";";
		}
		else if(member(lang,["swift","kotlin"])){
			to_return = "typealias "+type1+" = "+type2;
		}
		else if(member(lang,["standard ml","futhark"])){
			to_return = "type "+type1+" = "+type2;
		}
		else if(member(lang,["q#"])){
			to_return = "newtype "+type1+" = "+type2;
		}
		else if(member(lang,["haskell","coq","f#","ocaml"])){
			to_return = generate_code(input_lang,lang,indent,["algebraic_data_type",type1,type2]);
		}
		...
		else if(member(lang, ["haxe","typescript","simit","scala","swift"])){
			if(var_type(input_lang,"java",arr[1]) === "Object"){
				to_return = "var " + arr[2];
			}
			else{
	...
	// see http://rosettacode.org/wiki/Real_constants_and_functions
		...
		[["ruby","perl 6"],[".",["$a","abs"]]],
		[["c","pari/gp","axiom","modelica","asciimath","opl","english","hlsl","symja","maxima","standard ml","octave","haskell","common lisp","reverse polish notation","rebol","c++","julia","tcl","perl","php","python","cython","coconut","erlang","prolog","swift","frink"],["function_call","abs",["$a"]]]
	],matching_symbols)){
		var output = generate_code(input_lang,lang,indent,matching_symbols["$a"]);
	...
	,matching_symbols)){
		...
		if(member(lang,["mysql","sql","thrift","erlang","haskell","kotlin","sidef","ruby","purescript"])){
			return a.join(",");
		}
		else if(member(lang,["rust"])){
			return a.join(",")+",";
		}
		else if(member(lang,["ocaml","pascal","delphi","vhdl","coq"])){
			return a.join(";")+";";
		}
		else{
			return a.join("");
		...
		if(member(lang,["minizinc","maxima","ocaml","mysql","songbird"])){
			var a = arr[1].map(function(a1){
				return generate_code(input_lang,lang,indent,a1);
			});
			return a.join("; ")+";";
...
function while_loop(lang,arr1,arr2,indent){
	...
	else if(member(lang,["dafny","icon"])){
		return "while " + arr1 + "{" + arr2 + indent+ "}";
	}
	else if(member(lang,["yacas"])){
...
function function_call(lang, name, params){
	return inputs_to_outputs(lang,{name:name,params:params},
		...
		["wolfram","ruby-prolog","nearley"],
			"name[params]",
		["haskell","pure","core.logic","coq","futhark","twelf","emacs lisp","egison","agda","kif","isabelle/hol","cyc","common prolog","hy","clips","pddl","smt-lib","clips","clojure","minikanren","common lisp","clips","racket","scheme"],
			"(name params)"
	);
}
...
function initializer_list(input_lang,lang,list_inner){
	var to_return;
	if(member(lang,["ruby","interactive data language","hs-logic","lean","fermat","q#","futhark","openscad","agda","icon","asciimath","standard ml","coq","erlang","maxima","elm","cosmos", "python","sage","coconut", "cython", "nim","d","frink","octave","julia","prolog","constraint handling rules","minizinc","engscript","cython","groovy","dart","typescript","coffeescript","nemerle","javascript","haxe","haskell","polish notation","swift"])){
		to_return = "["+list_inner.join(",")+"]";
	}
