...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,24],$V1=[1,22],$V2=[1,29],$V3=[1,8],$V4=[1,27],$V5=[1,9],$V6=[1,10],$V7=[1,11],$V8=[1,20],$V9=[1,12],$Va=[1,13],$Vb=[1,15],$Vc=[1,32],$Vd=[1,16],$Ve=[1,17],$Vf=[1,18],$Vg=[1,19],$Vh=[1,30],$Vi=[1,26],$Vj=[1,31],$Vk=[5,32,33,34,37,38,40,42,43,46,49,51,54,56,57,58,59,60,95,98,101],$Vl=[5,23,32,33,34,35,37,38,40,42,43,46,49,51,54,56,57,58,59,60,95,98,101],$Vm=[1,40],$Vn=[1,42],$Vo=[1,43],$Vp=[1,47],$Vq=[9,39],$Vr=[1,57],$Vs=[1,50],$Vt=[1,51],$Vu=[1,53],$Vv=[1,54],$Vw=[1,55],$Vx=[9,39,94,95],$Vy=[2,95],$Vz=[2,103],$VA=[1,72],$VB=[1,64],$VC=[1,65],$VD=[1,66],$VE=[1,67],$VF=[1,68],$VG=[1,69],$VH=[1,70],$VI=[1,71],$VJ=[9,22,35,39,47,71,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,96,103],$VK=[9,22,35,39,47,71,73,74,75,76,77,78,79,80,81,82,83,84,85,86,87,88,94,95,96,103],$VL=[1,82],$VM=[1,78],$VN=[1,81],$VO=[2,104],$VP=[1,98],$VQ=[1,108],$VR=[2,109],$VS=[1,117],$VT=[1,110],$VU=[1,111],$VV=[1,112],$VW=[1,113],$VX=[1,114],$VY=[1,115],$VZ=[1,116],$V_=[1,118],$V$=[1,119],$V01=[1,120],$V11=[1,121],$V21=[1,122],$V31=[1,123],$V41=[1,124],$V51=[1,125],$V61=[1,126],$V71=[1,127],$V81=[2,119],$V91=[1,134],$Va1=[1,135],$Vb1=[35,103],$Vc1=[1,152],$Vd1=[1,153],$Ve1=[39,96],$Vf1=[23,35],$Vg1=[9,94,95],$Vh1=[23,32,33,34,35,37,38,40,42,43,46,49,51,54,56,57,58,59,60,95,98,101],$Vi1=[5,23,32,33,34,35,37,38,40,42,43,46,49,51,54,56,57,58,59,60,95,98,101,105],$Vj1=[39,103],$Vk1=[1,198],$Vl1=[1,197],$Vm1=[9,22,35,39,71,73,74,96,103],$Vn1=[9,22,35,39,71,73,74,75,76,96,103],$Vo1=[9,22,35,39,47,71,73,74,75,76,77,78,79,80,81,82,83,96,103],$Vp1=[9,22,35,39,47,71,73,74,75,76,77,78,79,80,81,82,83,84,85,96,103],$Vq1=[1,228],$Vr1=[1,234],$Vs1=[26,35],$Vt1=[33,35,53];
...
productions_: [0,[3,2],[4,2],[4,1],[6,1],[6,2],[10,1],[10,2],[10,3],[13,2],[13,1],[11,3],[11,1],[14,3],[14,1],[16,1],[18,1],[19,6],[24,2],[24,1],[25,4],[25,1],[17,2],[17,1],[28,1],[28,1],[31,5],[7,2],[7,1],[7,7],[7,5],[7,7],[7,7],[7,8],[7,9],[7,6],[7,5],[7,8],[48,1],[48,1],[27,8],[27,7],[36,4],[36,1],[36,2],[36,1],[36,2],[36,4],[36,2],[36,3],[36,3],[36,2],[36,2],[36,3],[36,3],[36,3],[36,3],[36,3],[36,1],[8,1],[15,1],[12,4],[21,5],[21,2],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,3],[21,2],[21,1],[89,2],[89,2],[89,2],[89,1],[45,3],[45,1],[63,4],[93,7],[93,3],[93,4],[93,4],[93,5],[93,1],[93,3],[93,1],[99,2],[99,3],[99,2],[99,3],[99,1],[99,1],[99,1],[102,3],[102,1],[52,3],[52,1],[52,0],[97,3],[97,1],[100,3],[100,1],[104,3],[104,3],[50,7],[50,2],[62,3],[62,1],[41,3],[41,2]],
...
this.$ = $$[$0-1].concat([$$[$0]]);
break;
case 3: case 10: case 14: case 19: case 23: case 88: case 108:
this.$ =
 [$$[$0]];
break;
case 5:
...
break;
case 43: case 111: case 113: case 119:
this.$ = [$$[$0]];
break;
case 44:
this.$ = ["return",$$[$0]];
...
this.$ = [$$[$0],$$[$0-1]];
break;
case 53: case 54: case 55: case 56: case 57: case 64: case 65: case 66: case 67: case 72: case 73: case 74: case 75: case 76: case 77: case 78: case 79: case 80:
this.$ = [$$[$0-1],$$[$0-2],$$[$0]];
break;
case 58:
this.$ = [".",$$[$0]]
...
this.$ = [".", $$[$0]];
break;
case 87: case 107: case 110: case 118:
this.$ = [$$[$0-2]].concat($$[$0]);
break;
case 89:
