...
//const list_of_languages = "Erlang,Octave,Picat,MiniZinc,Perl,Go,Swift,C,Fortran,Z3,Python,REBOL,Haskell,Visual Basic .NET,PHP,Ruby,Lua,C++,Haxe,Java,JavaScript,C#".split(",");
const list_of_languages = 'Delphi,Racket,Common Lisp,Clojure'.split(",");

const list_of_grammar_notations = "peg.js,pyparsing,EBNF,nearley".split(',');
...
function pattern_to_input(functionName, lang){
	...
	for(var i = 0; i < theString.length; i++){
		if((theString[i].indexOf(":") !== -1) && theString[i][0] !== ":" && theString[i][0] !== "=" && theString[i][theString[i].length-1] !== ":"){
...
`statement,a:statement
	...
	EnglishScript,VBScript,Java,Scala,Python,Dart,JavaScript,TypeScript,C#,PHP,Haxe,Ruby,C++,Visual Basic .NET,Go,Swift,REBOL,Fortran
...
statement_with_semicolon,var1:(print/set_var/plus_equals/minus_equals/exception/declare_constant/initialize_var/declare_new_object/typeless_initialize_var/set_array_size/initialize_empty_var/return/function_call)
	C,PHP,Dafny,Chapel,Katahdin,Frink,Falcon,Aldor,IDP,Processing,Maxima,Seed7,Drools,EBNF,ANTLR,EngScript,OpenOffice Basic,Ada,ALGOL 68,D,Ceylon,Rust,TypeScript,Octave,AutoHotKey,Pascal,Delphi,JavaScript,Pike,Objective-C,OCaml,Java,Scala,Dart,PHP,C#,C++,Haxe,AWK,bc,Perl,Perl 6,Nemerle,Vala
		var1 ;
	MiniZinc
...
_enum_list,a:Identifier
	Java,Perl 6,Swift,C++,C#,Visual Basic .NET,Haxe,Fortran,TypeScript,C,Ada,Scala
		a
	Go
		a = iota
	Python
...
enum_list,a:_enum_list,b:enum_list
	Java,C++,C#,C,TypeScript,Fortran,Ada,Scala
		a , b
	Haxe
		a ; b
...
asin,a:expression
	...
	Python,Lua
		math . asin ( a )
	Perl,C,Fortran,D,PHP,Hack,Dart,Scala
		asin ( a )
...
greater_than,a:Add,b:Add
	Pascal,E,VBScript,LiveCode,Monkey X,Perl 6,EnglishScript,Cython,GAP,Mathematical notation,Wolfram,Chapel,Katahdin,Frink,MiniZinc,Picat,Java,ECLiPSe,D,ooc,Genie,Janus,PL/I,IDP,Processing,Maxima,Seed7,Self,GNU Smalltalk,Drools,Standard ML,Oz,Cobra,Pike,Prolog,EngScript,Kotlin,Pawn,FreeBASIC,MATLAB,Ada,FreeBASIC,Gosu,Gambas,Nimrod,AutoIt,ALGOL 68,Ceylon,Groovy,Rust,CoffeeScript,TypeScript,Fortran,Octave,ML,Hack,AutoHotKey,Scala,Delphi,Tcl,Swift,Vala,C,F#,C++,Dart,JavaScript,REBOL,Julia,Erlang,OCaml,crosslanguage,C#,Nemerle,AWK,Java,Lua,Perl,Haxe,Python,PHP,Haskell,Go,Ruby,R,bc,Visual Basic,Visual Basic .NET
		a > b
	Racket,Z3,CLIPS,GNU Smalltalk,newLisp,Hy,Common Lisp,Emacs Lisp,Clojure,Sibilant,LispyScript
		( > __ a:Factor __ b:Factor )
	Polish notation
...
absolute_value,a:expression
	Lua
		math . abs ( a )
	C,Octave,Picat,C++,Swift,Python,Fortran,PHP,Hack,Perl,Dart,Julia,Scala,LiveCode
		abs ( a )
	C#,Visual Basic,Visual Basic .NET
		Math . Abs ( a )
	Ruby
...
_initializer_list,var1:expression,var2:initializer_list_separator,var3:(_initializer_list/expression)
	Lua,Octave,Picat,Julia,Polish notation,Reverse Polish notation,Visual Basic .NET,Dart,Java,Go,C++,JavaScript,C#,Perl,Fortran,C,PHP,Haskell,Haxe,Python,Ruby,TypeScript,MiniZinc,Prolog,REBOL,Swift
		var1 var2 var3
...
not_equal,a:parentheses_expression,b:parentheses_expression
	...
	JavaScript,PHP,TypeScript
		a !== b
	Java,Octave,R,Picat,EnglishScript,Perl 6,Wolfram,C,C++,D,C#,Julia,Perl,Ruby,Haxe,Python,Cython,MiniZinc,Scala,Swift,Go,Rust,Vala
		a != b
	English
	...
	Z3
		( not ( = __ a __ b ) )
	REBOL,Visual Basic .NET,Visual Basic,GAP,OCaml,LiveCode,Monkey X,VBScript,Delphi
		a <> b
	Erlang,Haskell
		a /= b
...
Or,var1:greater_than,var2:Or
	JavaScript,Perl 6,Wolfram,Chapel,Elixir,Frink,ooc,Picat,Janus,Processing,Pike,nools,Pawn,MATLAB,Hack,Gosu,Rust,AutoIt,AutoHotKey,TypeScript,Ceylon,Groovy,D,Octave,AWK,Julia,Scala,F#,Swift,Nemerle,Vala,Go,Perl,Java,Haskell,Haxe,C,C++,C#,Dart,R
		var1 || var2
	Python,LiveCode,EnglishScript,Cython,GAP,Mathematical notation,Genie,IDP,Maxima,EngScript,Ada,newLisp,OCaml,Nimrod,CoffeeScript,Pascal,Delphi,Erlang,REBOL,Lua,PHP,crosslanguage,Ruby
		var1 __ or __ var2
	Fortran
		var1 __ .OR. __ var2
...
initializer_list_separator
	Python,Polish notation,Reverse Polish notation,D,Frink,Fortran,Chapel,Octave,Julia,English,Pascal,Delphi,Prolog,MiniZinc,EngScript,Cython,Groovy,Dart,TypeScript,CoffeeScript,Nemerle,JavaScript,Haxe,Haskell,Ruby,REBOL,Polish notation,Swift,Java,Picat,C#,Go,Lua,C++,C,Visual Basic .NET,Visual Basic,PHP,Scala,Perl,Wolfram
		,
	REBOL
		__
...
strcmp,a:parentheses_expression,b:parentheses_expression
	...
	Visual Basic,Delphi,Visual Basic .NET,VBScript,F#,Prolog,Mathematical notation,OCaml,LiveCode,Monkey X
		a = b
	Python,Perl 6,EnglishScript,Chapel,Julia,Fortran,MiniZinc,Picat,Go,Vala,AutoIt,REBOL,Ceylon,Groovy,Scala,CoffeeScript,AWK,Ruby,Haskell,Haxe,Dart,Lua,Swift
		a == b
...
sqrt,x:expression
	...
	C#,Visual Basic .NET
		Math . Sqrt ( x )
	C,Julia,Perl,PHP,Perl 6,Maxima,MiniZinc,Prolog,Octave,D,Haskell,Swift,Mathematical notation,Dart,Picat
		sqrt ( x )
	Lua,Python
		math . sqrt ( x )
	REBOL
...
plus_equals,a:(access_array/dot_notation/Identifier),b:expression
	Janus,Perl 6,Dart,Visual Basic .NET,TypeScript,Python,Lua,Java,C,C++,C#,JavaScript,Haxe,PHP,Chapel,Perl,Julia,Scala,Rust,Go,Swift
		a += b
	Ruby,Haskell,Fortran,OCaml,MiniZinc,Octave,Delphi
		a = a + b
	Picat
		a := a + b
	REBOL
...
minus_equals,a:(dot_notation/access_array/Identifier),b:expression
	Janus,Perl 6,Dart,Perl,Visual Basic .NET,TypeScript,Python,Lua,Java,C,C++,C#,JavaScript,PHP,Haxe,Hack,Julia,Scala,Rust,Go,Swift
		a -= b
	Ruby,Haskell,Fortran,OCaml,MiniZinc,Octave,Delphi
		a = a - b
	Picat
...
concatenate_string,a:Multiply,b:concatenate_string
	...
	C,Monkey X,EnglishScript,Mathematical notation,Go,Java,Chapel,Frink,FreeBASIC,Nemerle,D,Cython,Ceylon,CoffeeScript,TypeScript,Dart,Gosu,Groovy,Scala,Swift,F#,Python,JavaScript,C#,Haxe,Ruby,C++,Vala
		a + b
	Lua,EngScript
		a .. b
	Fortran
	...
	Delphi
		Concat ( a , b )
	Visual Basic,Gambas,Nimrod,AutoIt,Visual Basic .NET,OpenOffice Basic,LiveCode,VBScript
		a & b
	Elixir,Wolfram
		a <> b
	Perl 6
...
split,aString:parentheses_expression,separator:parentheses_expression
	...
	JavaScript,CoffeeScript,Java,Python,Dart,Scala,Groovy,Haxe,Ruby,Rust,TypeScript,Cython
...
pow,a:expression,b:expression
	...
	JavaScript,Java,TypeScript,Haxe
		Math . pow ( a , b )
	Python,Cython,Chapel,Haskell,COBOL,Picat,ooc,PL/I,REXX,Maxima,AWK,R,F#,AutoHotKey,Tcl,AutoIt,Groovy,Octave,Ruby,Perl,Fortran
		( a ** b )
	REBOL
		power __ a __ b
...
case_statements,a:case,b:case_statements
	Java,Octave,OCaml,C,C#,C++,JavaScript,PHP,Haxe,Fortran,Ruby,Dart,TypeScript,Scala,Haskell,Visual Basic .NET,Swift,REBOL
		a __ b
	Erlang
		a ; b
...
mod,a:parentheses_expression,b:parentheses_expression
	...
	REBOL
		mod __ a __ b
	Haskell,MiniZinc,OCaml,Delphi,Pascal,Picat,LiveCode
		a __ mod __ b
...
sin,var1:expression
	...
	Lua,Python
		math . sin ( var1 )
	C,Erlang,Picat,Mathematical notation,Julia,D,PHP,Perl,Perl 6,Maxima,Fortran,MiniZinc,Swift,Prolog,Octave,Dart,Haskell,C++,Scala
		sin ( var1 )
	C#,Visual Basic .NET
		Math . Sin ( var1 )
	Wolfram
...
function_call,theName:dot_notation,args:(function_call_parameters/_)
	C,GAP,Mathematical notation,Chapel,Elixir,Janus,Perl 6,Pascal,Rust,Hack,Katahdin,MiniZinc,Pawn,Aldor,Picat,D,Genie,ooc,PL/I,Delphi,Standard ML,REXX,Falcon,IDP,Processing,Maxima,Swift,Boo,R,MATLAB,AutoIt,Pike,Gosu,AWK,AutoHotKey,Gambas,Kotlin,Nemerle,EngScript,Prolog,Groovy,Scala,CoffeeScript,Julia,TypeScript,Fortran,Octave,C++,Go,Cobra,Ruby,Vala,F#,Java,Ceylon,OCaml,Erlang,Python,C#,Lua,Haxe,JavaScript,Dart,bc,Visual Basic,Visual Basic .NET,PHP,Perl
		theName ( args )
...
function,type:type,params:function_parameters,name:Identifier,body:series_of_statements
	...
	Ruby,LiveCode,Janus,Lua,Haskell,CLIPS,MiniZinc,Julia,Octave,Picat,Pascal,Delphi,Maxima,OCaml,F#
		else __ a
	Erlang
		true -> a
	Wolfram,Prolog
	...
	Reverse Polish notation
		a __ else
true
	Java,LiveCode,GAP,Dafny,Z3,Perl 6,Chapel,C,Frink,Elixir,English,Pascal,MiniZinc,EngScript,Picat,Rust,Clojure,Nimrod,Hack,Ceylon,D,Groovy,CoffeeScript,TypeScript,Octave,Prolog,Julia,F#,Swift,Nemerle,Vala,C++,Dart,JavaScript,Ruby,Erlang,C#,Haxe,Go,OCaml,Lua,Scala,PHP,REBOL
		true
	Python,Hy,Cython,AutoIt,Haskell,Visual Basic .NET,VBScript,Visual Basic,Monkey X,Wolfram,Delphi
		True
	Perl,AWK,Tcl
		1
	Racket
	...
	R
		TRUE
false
	Java,LiveCode,GAP,Dafny,Z3,Perl 6,Chapel,C,Frink,Elixir,Pascal,Rust,MiniZinc,EngScript,Picat,Clojure,Nimrod,Groovy,D,Ceylon,TypeScript,CoffeeScript,Octave,Prolog,Julia,Vala,F#,Swift,C++,Nemerle,Dart,JavaScript,Ruby,Erlang,C#,Haxe,Go,OCaml,Lua,Scala,PHP,REBOL,Hack
		false
	Python,Hy,Cython,AutoIt,Haskell,Visual Basic .NET,VBScript,Visual Basic,Monkey X,Wolfram,Delphi
		False
	Perl,AWK,Tcl
...
return,a:expression,function_name:Identifier
	VBScript
		function_name = a
	Java,E,LiveCode,EnglishScript,Cython,GAP,Kal,EngScript,Pawn,Ada,PowerShell,Rust,D,Ceylon,TypeScript,Hack,AutoHotKey,Gosu,Swift,Pike,Objective-C,C,Groovy,Scala,CoffeeScript,Julia,Dart,C#,JavaScript,Go,Haxe,PHP,C++,Perl,Vala,Lua,Python,REBOL,Ruby,Tcl,AWK,bc,Chapel,Perl 6
		return __ a
	MiniZinc,Polish notation,Reverse Polish notation,Mathematical notation,Emacs Lisp,Z3,Erlang,Maxima,Standard ML,Icon,Oz,CLIPS,newLisp,Hy,Sibilant,LispyScript,ALGOL 68,Clojure,Prolog,Common Lisp,F#,OCaml,Haskell,ML,Racket,Nemerle
		a
...
string
	Z3,Java,Ceylon,Gambas,Dart,Gosu,Groovy,Scala,Pascal,Swift,Ruby,Haxe,Haskell,Visual Basic,Visual Basic .NET,Monkey X
		String
	Vala,Octave,Picat,Mathematical notation,Polish notation,Reverse Polish notation,Prolog,D,crosslanguage,Chapel,MiniZinc,Genie,Hack,Nimrod,ALGOL 68,TypeScript,CoffeeScript,Octave,Tcl,AWK,Julia,C#,F#,Perl,Lua,JavaScript,Go,PHP,C++,Nemerle,Erlang
		string
	C
		char*
	REBOL
	...
	Python,Hy
		str
void
	EngScript,PHP,Hy,Cython,Go,Pike,Objective-C,Java,C,C++,C#,Vala,TypeScript,D,JavaScript,Lua,Dart
		void
	Haxe,Swift
		Void
	Scala
...
boolean
	TypeScript,Python,Hy,Java,JavaScript,Lua,Perl
		boolean
	C++,Octave,Dafny,Chapel,C,crosslanguage,Rust,MiniZinc,EngScript,Dart,D,Vala,crosslanguage,Go,Cobra,C#,F#,PHP,Hack
		bool
	Haxe,Haskell,Swift,Julia,Perl 6,Z3,Monkey X
		Bool
	Fortran
		LOGICAL
...
compare_ints,var1:Add,var2:Add
	R
		identical ( var1 , var2 )
	Lua,E,Ceylon,Perl 6,EnglishScript,Cython,Mathematical notation,Dafny,Wolfram,D,Rust,R,MiniZinc,Frink,Picat,Pike,Pawn,Processing,C++,Ceylon,CoffeeScript,Octave,Swift,AWK,Julia,Perl,Groovy,Erlang,Haxe,Scala,Java,Vala,Dart,Python,C#,C,Go,Haskell,Ruby
		var1 == var2
	JavaScript,PHP,TypeScript,Hack
		var1 === var2
	...
	Fortran
		var1 .eq. var2
	Maxima,Monkey X,GAP,REBOL,F#,AutoIt,Pascal,Delphi,Visual Basic,Visual Basic .NET,OCaml,LiveCode,VBScript
		var1 = var2
	Prolog
		var1 =:= var2
	Clojure
...
array_access_list,var1:array_access_index,var2:array_access_list,separator:array_access_separator
	Java,Octave,Picat,Julia,Go,C#,Lua,C++,Python,JavaScript,C,PHP,Ruby,Scala,Haxe,Fortran,TypeScript,MiniZinc,Dart,Visual Basic .NET,Perl,Swift,Haskell,REBOL
		var1 separator var2
array_access_separator
	C#,MiniZinc,Fortran,Julia,Visual Basic,Visual Basic .NET,Octave
		,
	Python,D,Lua,Picat,Janus,Nimrod,AutoIt,Cython,CoffeeScript,Dart,TypeScript,AWK,Vala,Perl,Java,JavaScript,Ruby,Go,C++,PHP,Haxe,C,Swift
		][
	Haskell
		!!
	Scala
...
for(var current1 of "Add,sqrt,sin,cos,tan,absolute_value,pow,import,concatenate_string,Multiply,function,series_of_statements,parentheses_expression,if,elif,else,And,Or,not,strcmp,compare_ints,less_than,greater_than,less_than_or_equal,return,array_access_list,_initializer_list,array_access_separator,true,false,exception,initialize_instance_variable,initialize_instance_variable_with_value,initialize_static_variable,initialize_static_variable_with_value,initialize_var,initialize_empty_var,typeless_initialize_var,assert,enum,enum_list,list_comprehension,reverse_string,reverse_array,array_access_index,string_to_int,elif_or_else,print,mod,function_parameters,greater_than_or_equal,not_equal".split(',')){
	try{
