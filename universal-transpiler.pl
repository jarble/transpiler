...
statement(Data,Type1,function(Name1,Type1,Params1,Body1)) -->
        ...
        ['vbscript']:
                ("Function",ws_,Name,ws,"(",ws,Params,ws,")",ws_,Body,ws_,"End",(Indent;ws_),"Function"),
        ['racket','newlisp']:
...
statement(Data,Return_type,if(Expr_,Statements_,Elif_or_else_,Else_)) -->
		...
		['fortran']:
				("IF",ws_,A,ws_,"THEN",ws_,B,ws_,C,ws_,D,ws_,"END",ws_,"IF"),
		['rebol']:
		...
		['visual basic','visual basic .net']:
				("If",ws_,A,ws_,B,ws_,C,ws_,D,ws_,"End If"),
		['clips']:
