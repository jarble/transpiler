...
GC_API GC_API_FIX GC_word GC_gc_no;/* Counter incremented per collection.  	*/
			/* Includes empty GCs at startup.		*/

GC_API GC_API_FIX int GC_parallel;	/* GC is parallelized for performance on	*/
...
GC_API GC_API_FIX GC_PTR (*GC_oom_fn) GC_PROTO((size_t bytes_requested));
...
GC_API GC_API_FIX int GC_find_leak;
			/* Do not actually garbage collect, but simply	*/
			/* report inaccessible memory that was not	*/
			/* deallocated with GC_free.  Initial value	*/
			/* is determined by FIND_LEAK macro.		*/

GC_API GC_API_FIX int GC_all_interior_pointers;
...
GC_API GC_API_FIX int GC_quiet;	/* Disable statistics output.  Only matters if	*/
			/* collector has been compiled with statistics	*/
			/* enabled.  This involves a performance cost,	*/
			/* and is thus not the default.			*/

GC_API GC_API_FIX int GC_finalize_on_demand;
...
GC_API GC_API_FIX int GC_java_finalization;
...
GC_API GC_API_FIX void (* GC_finalizer_notifier)();
...
GC_API GC_API_FIX int GC_dont_gc;	/* != 0 ==> Dont collect.  In versions 6.2a1+,	*/
...
GC_API GC_API_FIX int GC_dont_expand;
			/* Dont expand heap unless explicitly requested */
			/* or forced to.				*/

GC_API GC_API_FIX int GC_use_entire_heap;
...
GC_API GC_API_FIX int GC_full_freq;    /* Number of partial collections between	*/
...
GC_API GC_API_FIX GC_word GC_non_gc_bytes;
			/* Bytes not considered candidates for collection. */
			/* Used only to control scheduling of collections. */
			/* Updated by GC_malloc_uncollectable and GC_free. */
			/* Wizards only.				   */

GC_API GC_API_FIX int GC_no_dls;
...
GC_API GC_API_FIX GC_word GC_free_space_divisor;
...
GC_API GC_API_FIX GC_word GC_max_retries;
			/* The maximum number of GCs attempted before	*/
			/* reporting out of memory after heap		*/
			/* expansion fails.  Initially 0.		*/
			

GC_API GC_API_FIX char *GC_stackbottom;	/* Cool end of user stack.		*/
...
GC_API GC_API_FIX int GC_dont_precollect;  /* Don't collect as part of 		*/
...
GC_API GC_API_FIX unsigned long GC_time_limit;
...
GC_API GC_API_FIX void (*GC_same_obj_print_proc) GC_PROTO((GC_PTR p, GC_PTR q));

GC_API GC_API_FIX void (*GC_is_valid_displacement_print_proc)
	GC_PROTO((GC_PTR p));

GC_API GC_API_FIX void (*GC_is_visible_print_proc)
	GC_PROTO((GC_PTR p));
