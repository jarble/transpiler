...
instance_method_(Data,[Name,Type,Params,Body]) -->
...
or(javascript,[Var1,Var2]) -->
	(Var1,ws,"||",ws,Var2).

or(java,A) --> or(javascript,A).
or('c',A) --> or(java,A).
or('c#',A) --> or('c',A).
or(ruby,A) --> or(c,A).
or(haxe,A) --> or(c,A).

last_index_of_(Data,A) -->
    Data = [Lang|_],
    last_index_of(Lang,A).

last_index_of(haxe,[String,Substring]) --> 
